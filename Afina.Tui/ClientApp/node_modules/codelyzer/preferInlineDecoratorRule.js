...
var object_keys_1 = require("./util/object-keys");
...
var Rule = (function (_super) {
    ...
    Rule.prototype.areOptionsValid = function () {
        ...
        var ruleArgumentsKeys = object_keys_1.objectKeys(ruleArgument);
        var propertiesKeys = object_keys_1.objectKeys(ruleOptions.properties);
        return (ruleArgumentsKeys.every(function (argumentKey) { return propertiesKeys.indexOf(argumentKey) !== -1; }) &&
            ruleArgumentsKeys
                ...
                if (!argumentValue || typeof argumentValue !== 'object')
                    return false;
                var argumentValueKeys = object_keys_1.objectKeys(argumentValue);
...
var hasAnyIgnoredDecorator = function (walkContext, decorators, optionKey) {
    var nonIgnoredDecoratorNames = decorators
        ...
        .filter(is_not_null_or_undefined_1.isNotNullOrUndefined)
